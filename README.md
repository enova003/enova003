...
Key Features:
 ...
 - Send email functionality using an integrated API
 - Original design
...
Key Features:
 - Interactive pizza quiz for determining which pizza to purchase
...
Key Features:
 - Personality test based on 16Personalities
